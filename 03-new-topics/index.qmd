...
![Figure 1 reproduced from @stivalaUsingSampledNetwork2020](alaam-diagram)
:::
...
![Figure 3 reproduced from @brandenbergerInterdependenciesConflictDynamics2020](rem.png)
...
[^nonet]: No network visualization in the paper... as it usually happens in SNA papers! -->

::: {.column width=45%}
![Partial map of the Internet based on the January 15, 2005 data found on opte.org. -- [Wiki](https://en.wikipedia.org/w/index.php?title=File:Internet_map_1024.jpg&oldid=1061830697)](bignet.jpg){width=100%}
:::
...
![Five small networks from the `ergmito` R package](littlenet.jpg){width=40%}
...
![Reproduced from @krivitskyRejoinderDiscussionTale2023](fig1-rejoinder.png)
...
![Simulation study trying to demonstrate the concept (Work in progress)](condergm.png)
